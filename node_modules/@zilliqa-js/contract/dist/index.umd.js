(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@zilliqa-js/account'), require('@zilliqa-js/core'), require('@zilliqa-js/crypto'), require('@zilliqa-js/util')) :
	typeof define === 'function' && define.amd ? define(['exports', '@zilliqa-js/account', '@zilliqa-js/core', '@zilliqa-js/crypto', '@zilliqa-js/util'], factory) :
	(factory((global.zjsContract = {}),global.zjsAccount,global.zjsCore,global.zjsCrypto,global.zjsUtil));
}(this, (function (exports,account,core,crypto,util) { 'use strict';
	...
	***************************************************************************** */
	...
	var Contracts = /** @class */ (function () {
	    ...
	    Contracts.getAddressForContract = function (tx) {
	        ...
	        return crypto.toChecksumAddress(hash_1
	            .sha256()
