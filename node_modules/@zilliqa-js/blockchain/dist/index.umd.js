(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@zilliqa-js/crypto'), require('@zilliqa-js/util'), require('@zilliqa-js/account'), require('@zilliqa-js/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@zilliqa-js/crypto', '@zilliqa-js/util', '@zilliqa-js/account', '@zilliqa-js/core'], factory) :
    (factory((global.zjsBlockchain = {}),global.zjsCrypto,global.zjsUtil,global.zjsAccount,global.zjsCore));
}(this, (function (exports,crypto,util,account,core) { 'use strict';
